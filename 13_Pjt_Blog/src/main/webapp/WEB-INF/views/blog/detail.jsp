  ...
  <div>
    ...
    <script>
    		  ...
    		  success: function(resData){  // resData = { "commentList": [{}, {}, ...], "pageUtil": {beginPage: 1, endPage: 5, ...} }
    			  ...
    			  $.each(resData.commentList, function(i, comment){
					  ...
					  if(comment.state == -1){
    				  	...
    				  	str += '<div class="replyArea blind">'; /* 평소엔 숨어있으므로 클래스르 두개 준다. */
      ...
      function() fnToggleReplyArea(){
    	  $(document).on('click', '.btnOpenReply', function(){  // 동적인 객체는 이렇게 이벤트를 걸어주면된다, 스크립트로 만들어진 버튼은 이렇게 실행해주면 된다. 
