...
<script>
	...
	fnFileCheck(); /* 이렇게 한번 호출을 해줘야 한다 아래 body문에 따로 호출하는 태그가 없으니 onclick이 없으니  */
</script>
</head>
<body>
	...
	<div>
		...
		<form method="post" enctype="multipart/form-data" action="${contextPath}/upload/add.do">
			<div>
				<label for="uploadTile">제목</label>
				<input type="text" id="uploadTitle" name="uploadTile">
			</div>
			<div>
			...
			<div>
				...
				<input type="file" id="files" name="files" multiple="multiple" onchange="fnFileCheck(this)"> <!-- multiple : 다중 첨부가 가능해진다, this를 전달해주어야 한다. -->
