...
<script src="${contextPath}/resources/js/lib/jquery-migrate-1.4.1.min.js"></script>
<script>
	function fnInit() {
	...
	function fnSearchAll() { // 할일은 있지만 특별히 채워줄 본문 내용은 없다
		$.ajax({
			type: 'get',
			...
			success: function(resData) { // resData = {"message": "", "list": [{}, {}, {}, ...], "status": 200}
				...
				if(resData.status == 200) {
					$.each(resData.list, function(i, movie){
						...
						let str = '<tr>';
						str += '<td colsapn"4">조회된검색결과가 없습니다.';
						$('#movieList').append(str);
				}
			}
		})
